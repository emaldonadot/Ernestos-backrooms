...
| 4 | Puzzle & Progression (puzzle framework, locked route, exit room) | **In progress** — see [milestone-4-puzzle-progression.md](features/milestone-4-puzzle-progression.md) |
